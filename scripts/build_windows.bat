@echo off
REM NDI Output Plugin Windows Build Script with CUDA Support
REM Requires: Visual Studio 2019/2022, CUDA Toolkit 11.0+, NDI Advanced SDK

echo Building NDI Output Plugin for Windows with CUDA support...
...
if not %errorlevel%==0 goto ninja_error
...
echo Please install Ninja or use a different generator
exit /b 1
